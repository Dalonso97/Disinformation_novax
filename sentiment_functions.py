...
def sentiment_analysis(subset, date_start_vaccination):
    ...
    labels = 'Mean negative sentences', 'Mean positive sentences', 'Mean neutral sentences'
    ...
    labels_headlines = 'negative headlines', 'Positive headlines', 'Neutral headlines'
...
#     df_sentences=df_sentences.drop(df_sentences[df_sentences['label']==1].index, inplace=False)
    ...
    labels_sentences = 'Negative sentences', 'Positive sentences', 'Neutral sentences'
    ...
    ax1.set_title("Distribution of specific sentence sentiment", fontsize=18)
    plt.show()
